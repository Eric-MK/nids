...
# Load the datasets
train_file = './output_cnn_lstm/10t-10n-DOS2019-dataset-train-cnn-lstm.hdf5'
val_file = './output_cnn_lstm/10t-10n-DOS2019-dataset-val-cnn-lstm.hdf5'
test_file = './output_cnn_lstm/10t-10n-DOS2019-dataset-test-cnn-lstm.hdf5'
...
def create_cnn_lstm_model(input_shape_cnn, input_shape_lstm):
    ...
    x = Conv1D(64, 3, activation='relu')(cnn_input)
    x = MaxPooling1D(2)(x)
